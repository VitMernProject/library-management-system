...
const SignInPage = () => {
  return (
    <>
        <div className="vh-100 d-flex flex-column justify-content-center signin">
            ...
            <div className='admin p-4 mx-5 d-flex flex-column align-items-center' style={{width:'14rem'}}>
            ...
            <div className='student p-4 mx-5 d-flex flex-column align-items-center'style={{width:'14rem'}}> 
              <div className="card" style={{width: '8rem', background:'none'}}>
